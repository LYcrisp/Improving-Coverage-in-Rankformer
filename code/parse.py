...
def parse_args():
    ...
    # 新增参数
    parser.add_argument('--use_sgl', action='store_true')
    parser.add_argument('--sgl_lambda', type=float, default=0.01)
    parser.add_argument('--use_tail_loss', action='store_true')
    parser.add_argument('--use_coverage', action='store_true')
    parser.add_argument('--tail_lambda', type=float, default=0.1)
    # rankformer
